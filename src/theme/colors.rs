...
impl ThemeColors {
    ...
    pub fn default_light() -> Self {
        Self {
            ...
            bg_panel: rgba(0xF6F8FAff).into(),
            bg_surface: rgba(0xEBEDF0ff).into(),
            bg_elevated: rgba(0xDFE1E6ff).into(),
            transparent: rgba(0x00000000).into(),

            // -- Borders (visible grays on light bg) --
            border_subtle: rgba(0xD0D7DEff).into(),
            border_default: rgba(0xC0C8D0ff).into(),
            border_strong: rgba(0x8C959Fff).into(),

            // -- Text (dark on light, strong contrast) --
            text_primary: rgba(0x1F2328ff).into(),
            text_secondary: rgba(0x424A53ff).into(),
            text_muted: rgba(0x6E7781ff).into(),
            text_dimmed: rgba(0xAFB8C1ff).into(),
            text_bright: rgba(0x0D1117ff).into(),
            text_on_emphasis: rgba(0xFFFFFFff).into(),
            text_commit_hash: rgba(0x57606Aff).into(),
            text_commit_time: rgba(0x6E7781ff).into(),

            // -- Interactive (indigo accent, adjusted for light bg) --
            accent: rgba(0x5B5FC7ff).into(),
            element_hover: rgba(0xEBEDF0ff).into(),
            tab_hover: rgba(0xEBEDF0ff).into(),
            button_accent_hover: rgba(0x5B5FC74D).into(),
            element_selected: rgba(0x5B5FC740).into(),
            element_selected_inactive: rgba(0x5B5FC720).into(),
            selection_bg: rgba(0x96A3F860).into(),

            // -- Git status (GitHub-inspired, saturated for light bg) --
            git_added: rgba(0x1A7F37ff).into(),
            git_clean: rgba(0x1A7F37ff).into(),
            git_modified: rgba(0x9A6700ff).into(),
            git_dirty: rgba(0x9A6700ff).into(),
            git_deleted: rgba(0xCF222Eff).into(),
            git_renamed: rgba(0x0550AEff).into(),
            git_unknown: rgba(0x57606Aff).into(),

            // -- Git badge backgrounds (12% opacity on status colors) --
            git_added_bg: rgba(0x1A7F3720).into(),
            git_modified_bg: rgba(0x9A670020).into(),
            git_deleted_bg: rgba(0xCF222E20).into(),
            git_renamed_bg: rgba(0x0550AE20).into(),
            git_unknown_bg: rgba(0x57606A20).into(),

            // -- Diff (adjusted for light background contrast) --
            diff_add_text: rgba(0x1A7F37ff).into(),
            diff_add_line_bg: rgba(0x1A7F3712).into(),
            diff_add_word_bg: rgba(0x1A7F3740).into(),
            diff_remove_text: rgba(0xCF222Eff).into(),
            diff_remove_line_bg: rgba(0xCF222E12).into(),
            diff_remove_word_bg: rgba(0xCF222E40).into(),
            diff_hunk_text: rgba(0x5B5FC7ff).into(),
            diff_hunk_bg: rgba(0xF6F8FAff).into(),
            diff_context_text: rgba(0x424A53ff).into(),
            diff_gutter_text: rgba(0x6E7781ff).into(),

            // -- Decoration badges (GitHub-inspired for light bg) --
            badge_branch_bg: rgba(0x1A7F3720).into(),
            badge_branch_text: rgba(0x1A7F37ff).into(),
            badge_tag_bg: rgba(0x9A670020).into(),
            badge_tag_text: rgba(0x9A6700ff).into(),
            badge_head_bg: rgba(0x5B5FC720).into(),
            badge_head_text: rgba(0x5B5FC7ff).into(),
            badge_remote_bg: rgba(0x0550AE20).into(),
            badge_remote_text: rgba(0x0550AEff).into(),
